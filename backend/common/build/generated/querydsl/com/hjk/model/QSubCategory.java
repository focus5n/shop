...
public class QSubCategory extends EntityPathBase<SubCategory> {
    ...
    private static final long serialVersionUID = -1999240121L;
    ...
    public final QMainCategory main_category;
    ...
    public QSubCategory(Class<? extends SubCategory> type, PathMetadata metadata, PathInits inits) {
        ...
        this.main_category = inits.isInitialized("main_category") ? new QMainCategory(forProperty("main_category")) : null;
    }
